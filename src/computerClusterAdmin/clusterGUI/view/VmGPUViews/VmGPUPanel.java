package computerClusterAdmin.clusterGUI.view.VmGPUViews;
...
public class VmGPUPanel extends ControlledPanel{
    ...
    public VmGPUPanel(Controller gc) {
        super(gc);
        setLayout(null);
        ...
        btnOk.addActionListener((e) -> {
            this.gc.createVmGPU(cores, ram, ssd, os, gpu);
            cores.setText("");
            ram.setText("");
            ssd.setText("");
            os.setText("");
