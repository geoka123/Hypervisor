package computerClusterAdmin.clusterGUI.view.VmNetworkedViews;
...
public class VmNetworkedPanel extends ControlledPanel{
    ...
    public VmNetworkedPanel(Controller gc) {
        super(gc);
        setLayout(null);
        ...
        btnOk.addActionListener((e) -> {
            this.gc.createVmNetworked(cores, ram, ssd, os, bandwidth);
            cores.setText("");
            ram.setText("");
            ssd.setText("");
            os.setText("");
		...
		JLabel lblNewLabel_1_3_1 = new JLabel("B/W:");
		...
		bandwidth.setBackground(new Color(192, 192, 192));
		bandwidth.setColumns(10);
		bandwidth.setBounds(429, 212, 171, 19);
		add(bandwidth);
